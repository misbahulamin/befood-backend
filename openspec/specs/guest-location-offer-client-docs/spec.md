# guest-location-offer-client-docs Specification

## Purpose
TBD - created by archiving change fix-repeated-delivery-location-confirmation. Update Purpose after archive.
## Requirements
