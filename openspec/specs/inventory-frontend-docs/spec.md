...
Frontend integration documentation for the Admin Panel Inventory section: auth, endpoint grid, purchase/kitchen flows, dashboard card mapping, histories, invoice handling, and Admin Wallet cross-links.
