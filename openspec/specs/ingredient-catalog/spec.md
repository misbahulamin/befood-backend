...
Product catalog for meal-cycle costing: ingredients with kilogram-based or flat per-customer pricing and optional customer visibility. Serving `product_role` is assigned on meal-cycle plan lines, not on the catalog.
