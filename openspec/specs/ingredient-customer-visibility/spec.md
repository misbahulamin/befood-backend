...
Independent customer-facing visibility for ingredients: admins can hide costing-only items from customer/public menus while keeping them on plans and schedules for costing and admin tooling.
