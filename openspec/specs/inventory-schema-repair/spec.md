...
Ensure physical inventory database schema matches current Django models, and provide a safe repair path when migrations were recorded as applied but the legacy/incomplete schema remains.
