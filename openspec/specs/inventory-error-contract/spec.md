...
Stable, machine-readable error contracts for Admin Inventory web APIs so clients can map domain failures without treating raw database/schema errors as the normal path.
