...
Verified admins can list, review, approve, reject, and manage verified status for Delivery Man (`RiderProfile`) accounts, including a pending queue after email verification.
