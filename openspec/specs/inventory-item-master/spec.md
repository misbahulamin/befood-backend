...
Stockable kitchen inventory item master: unique items with allowlisted units, category, admin lifecycle status, minimum stock, and low/out-of-stock signals, separate from meal costing ingredients.
