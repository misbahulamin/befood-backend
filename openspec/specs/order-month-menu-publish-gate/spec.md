...
Meal package order creation requires a published monthly menu schedule for the selected meal month so customers cannot confirm into an unpublished cycle.
