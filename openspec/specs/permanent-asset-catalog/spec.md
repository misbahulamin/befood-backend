...
Domain catalog for permanent (non-consumable) kitchen and office assets—categories, identity, status lifecycle, optional outlet location, and purchase/warranty metadata—kept strictly separate from food inventory and meal costing.
